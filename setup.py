...
setup(
    ...
    description="A package to wipe out uncompliant VCF files",
    ...
    entry_points={
        'console_scripts': [
            'fastqwiper = vcf_wiper.wiper:vcf_fastq'
        ]
    },
    ...
    project_urls={
        ...
        'Source': 'https://github.com/mazzalab/vcfwiper',
        'Tracker': 'https://github.com/mazzalab/vcfwiper/issues',
        'Developmental plan': 'https://github.com/mazzalab/vcfwiper/projects',
    },
